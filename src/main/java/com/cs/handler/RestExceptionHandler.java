...
import com.cs.domain.dtos.ErrorDetails;
import com.cs.domain.dtos.RestErrorResponse;
import com.cs.enums.ServiceErrorCodes;
import com.cs.exceptions.BaseException;
 ...
 * @date 2019/08/12
 */
@RestControllerAdvice(basePackages = {"com.cs"})
